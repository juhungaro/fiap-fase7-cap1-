...
## 6. Roteiro Sugerido para o Vídeo Demonstrativo (Até 5 minutos)

### Minuto 0:00 – 1:00: Apresentação Inicial e Arquitetura
- Apresentar brevemente o grupo e o propósito da CardioIA.
- Mostrar na tela o diagrama de arquitetura contido no README.md e explicar a unificação dos dados.

### Minuto 1:00 – 2:00: Firmware MicroPython (Wokwi)
- Mostrar a simulação do Wokwi rodando com o ESP32, Display OLED e LEDs.
- Explicar como o MicroPython gera os batimentos simulados e faz a requisição HTTP POST.
- Demonstrar o LED vermelho piscando quando as medições indicam arritmia/taquicardia.

### Minuto 2:00 – 3:30: Interface Web (Vercel) e Backend
- Fazer login na interface Web publicada na Vercel (perfil médico).
- Mostrar a telemetria do IoT sendo atualizada no Dashboard em tempo real e o gráfico de BPM pulsando.
- Clicar nos botões de simulação e demonstrar a mudança imediata no velocímetro do Risco da IA.
- Clicar no botão "Triagem Multiagente" e exibir o relatório clínico e condutas.

### Minuto 3:30 – 4:30: Aplicativo Mobile (Expo) e Chatbot
- Mostrar o aplicativo móvel aberto (pode ser o emulador ou gravação do celular).
- Exibir a mesma telemetria e o indicador de risco.
- Abrir o Chatbot conversacional e enviar perguntas sobre sintomas (ex: "estou sentindo dor no peito com suor frio"). Exibir a resposta inteligente orientando a ligar para o SAMU.

### Minuto 4:30 – 5:00: Conclusão e Governança
- Mostrar no backend a criação do arquivo de logs de governança `decisoes_cardio_ia.jsonl` e a validação de coerência.
- Finalizar ressaltando o impacto de salvar vidas integrando IA e telemedicina de forma profissional.
